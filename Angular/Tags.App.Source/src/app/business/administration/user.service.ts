...
export class UserBusiness {
    ...
    ChangePassword(password:string, newPassword1:string, newPassword2:string, ): Promise<boolean> {
        if(newPassword1 != newPassword2)
            throw new Error("La contraseña y la confirmación de la contraseña no coinciden");
        
        var servObj = new ServiceObject("Users", "User", "ChangePassword");
       
        servObj.Data = { 
            userId: AppEnviroment.User.UserId,
