...
export class CatalogComponent implements OnInit {
  ...
  flat: boolean;
  constructor(private business: CatalogBusinessService, private toast: ToastService) {
    this.GetCatalogs();
    this.ListCatalog();
  }
  ngOnInit() {
  ...
  GetCatalogs() {
    this.business.GetCatalogs().then(x => {
  ...
  NewLocation(value, Create: boolean) {
    ...
    if (Create == false) {
      ...
      this.catalogValue.Creation = DateFormat;
