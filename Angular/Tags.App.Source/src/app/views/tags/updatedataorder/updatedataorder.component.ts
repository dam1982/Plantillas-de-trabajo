...
export class UpdateDataOrderComponent implements OnInit {
  ...
  async GetOrders() {
    ...
    this.orderArray[0].OrderLines.sort(function(a, b) {     
      return (a.ProductCode < b.ProductCode) ? -1 : (a.ProductCode > b.ProductCode) ? 1 : 0;
    });

    this.orderArray[1].OrderLines.sort(function(a, b) {     
      return (a.ProductCode < b.ProductCode) ? -1 : (a.ProductCode > b.ProductCode) ? 1 : 0;
    });
    ...
    let items = this.orderArray[1].OrderLines.map(orden => {
      return this.orderArray[0].OrderLines.find(x => x.ProductCode === orden.ProductCode)
